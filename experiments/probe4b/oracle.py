...
def main() -> None:
    ...
    trajectory_paths = {
        "synthetic_fobs": ROOT / "artifacts/probe4b_results/experiment_A_synthetic_fobs/altloc_test/trajectories.json",
        "localized_sf": ROOT / "artifacts/probe4b_results/experiment_B_localized_sf/altloc_test/trajectories.json",
        "realspace_local": ROOT / "artifacts/probe4b_results/experiment_C_realspace_local/altloc_test/trajectories.json",
    }
    learned_chi = {}
    ...
    out = ROOT / "artifacts/probe4b_results/oracle_A_vs_B.json"
