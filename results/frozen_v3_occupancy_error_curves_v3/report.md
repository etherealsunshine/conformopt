...
This report reshapes the 79 saved wrong-occupancy candidate RSCC values. It performs no density rendering, optimizer run, endpoint read, or metric recomputation.
...
Across all 80 site–decoy pairs, Spearman correlation between occupancy error and RSCC margin is **ρ = 0.8577**.
...
- Candidate rows read: 79 wrong-occupancy decoys from `per_candidate.csv`.
